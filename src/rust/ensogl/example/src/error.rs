...
pub fn run_example_error() {
    ...
    // child1.unset_parent();
    //
    // println!("{:?}",child1.display_object().is_visible());
    // println!("{:?}",child2.display_object().is_visible());
    //
    ...
    let world = display::object::Instance::<()>::new(Logger::new("world"));
    let node1 = display::object::Instance::<()>::new(Logger::new("node1"));
    let node2 = display::object::Instance::<()>::new(Logger::new("node2"));
    let node3 = display::object::Instance::<()>::new(Logger::new("node3"));
    let node4 = display::object::Instance::<()>::new(Logger::new("node4"));
    ...
    println!("{:?}",node3.display_object().is_visible());
    println!("{:?}",node4.display_object().is_visible());
