...
//        ]
        vec! [ Self::self_shortcut(shortcut::Press       , "left"                      , "cursor_move_left"),
               Self::self_shortcut(shortcut::Press       , "right"                     , "cursor_move_right"),
               Self::self_shortcut(shortcut::Press       , "up"                        , "cursor_move_up"),
               Self::self_shortcut(shortcut::Press       , "down"                      , "cursor_move_down"),
               Self::self_shortcut(shortcut::Press       , "meta + left"               , "cursor_move_left_word"),
               Self::self_shortcut(shortcut::Press       , "meta + right"              , "cursor_move_right_word"),
               Self::self_shortcut(shortcut::Press       , "shift + left"              , "cursor_select_left"),
               Self::self_shortcut(shortcut::Press       , "shift + right"             , "cursor_select_right"),
               Self::self_shortcut(shortcut::Press       , "meta + shift + left"       , "cursor_select_left_word"),
               Self::self_shortcut(shortcut::Press       , "meta + shift + right"      , "cursor_select_right_word"),
               Self::self_shortcut(shortcut::Press       , "shift + up"                , "cursor_select_up"),
               Self::self_shortcut(shortcut::Press       , "shift + down"              , "cursor_select_down"),
               Self::self_shortcut(shortcut::Press       , "backspace"                 , "delete_left"),
               Self::self_shortcut(shortcut::Press       , "meta + backspace"          , "delete_word_left"),
               Self::self_shortcut(shortcut::Press       , "shift + left-mouse-button" , "set_newest_selection_end_to_mouse_position"),
               Self::self_shortcut(shortcut::DoublePress , "left-mouse-button"         , "select_word_at_cursor"),
               Self::self_shortcut(shortcut::Press       , "left-mouse-button"         , "set_cursor_at_mouse_position"),
               Self::self_shortcut(shortcut::Press       , "left-mouse-button"         , "start_newest_selection_end_follow_mouse"),
               Self::self_shortcut(shortcut::Release     , "left-mouse-button"         , "stop_newest_selection_end_follow_mouse"),
               Self::self_shortcut(shortcut::Press       , "meta + left-mouse-button"  , "add_cursor_at_mouse_position"),
               Self::self_shortcut(shortcut::Press       , "meta + left-mouse-button"  , "start_newest_selection_end_follow_mouse"),
               Self::self_shortcut(shortcut::Release     , "meta + left-mouse-button"  , "stop_newest_selection_end_follow_mouse"),
               Self::self_shortcut(shortcut::Press       , "meta + a"                  , "select_all"),
               Self::self_shortcut(shortcut::Press       , "meta + c"                  , "copy"),
               Self::self_shortcut(shortcut::Press       , "meta + v"                  , "paste"),
               Self::self_shortcut(shortcut::Press       , "escape"                    , "paste"),
//             Self::self_shortcut(shortcut::Press   (&[Key::Escape]                          , shortcut::Pattern::Any) , "keep_oldest_cursor_only"),
//             Self::self_shortcut(shortcut::Press   (shortcut::Pattern::Any,&[])                                       , "insert_char_of_last_pressed_key"),
//             Self::self_shortcut(shortcut::Release (&[Key::Meta,Key::Character("z".into())],&[])                      , "undo"),
//             Self::self_shortcut(shortcut::Release (&[Key::Meta,Key::Character("y".into())],&[])                      , "redo"),
//             Self::self_shortcut(shortcut::Release (&[Key::Meta,Key::Shift,Key::Character("z".into())],&[])           , "redo"),
//             Self::self_shortcut(shortcut::Press   (&[Key::Escape]                          , shortcut::Pattern::Any) , "undo"),
        ]
    }
}
