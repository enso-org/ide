...
impl Entry {
    ...
    pub fn new(logger:impl AnyLogger, app:&Application) -> Self {
        ...
        let text_color = styles.get_color(ensogl_theme::widget::list_view::text::color);
    ...
    pub fn set_model(&self, id:Id, model:&Model) {
        ...
        let highlight             = styles.get_color(ensogl_theme::widget::list_view::text::highlight::color);
