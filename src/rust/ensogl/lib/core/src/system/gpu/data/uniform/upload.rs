...
impl UniformUpload for Vector2<u32> {
    fn upload_uniform(
        ...
        context
            .uniform2uiv_with_u32_array(Some(location), self.data.as_slice());
    }
}
...
impl UniformUpload for Vector3<u32> {
    fn upload_uniform(
        ...
        context
            .uniform3uiv_with_u32_array(Some(location), self.data.as_slice());
    }
}
...
impl UniformUpload for Vector4<u32> {
    fn upload_uniform(
        ...
        context
            .uniform4uiv_with_u32_array(Some(location), self.data.as_slice());
    }
}
