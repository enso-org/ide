...
use crate::prelude::*;
use crate::data::function::callback::FunctionMut0;
use crate::data::function::callback::FunctionMut1;
...
impl<T:IndexMut<Ix>, OnMut: FunctionMut1<Ix> ,OnResize, Ix:Copy>
...
impl <T:Extend<S>,S,OnMut,OnResize:FunctionMut0>
