...
pub fn expression_mock() -> Expression {
    ...
    let input_span_tree  = span_tree::builder::TreeBuilder::new(15)
        ...
        .add_child(5,10,span_tree::node::Kind::this(false),PrefixCrumb::Arg)
        .set_expression_id(Uuid::new_v4())
        .done()
...
pub fn expression_mock2() -> Expression {
    ...
    let input_span_tree  = span_tree::builder::TreeBuilder::new(36)
        .add_child(0,14,span_tree::node::Kind::Chained,PrefixCrumb::Func)
            ...
            .add_child(10,4,span_tree::node::Kind::this(true),PrefixCrumb::Arg)
                .set_expression_id(Uuid::new_v4())
                .done()
            .add_empty_child(14,span_tree::node::InsertionPointType::Append)
            .set_expression_id(Uuid::new_v4())
            .done()
        .add_child(15,21,span_tree::node::Kind::argument(true,None,None),PrefixCrumb::Arg)
            .set_expression_id(Uuid::new_v4())
            .add_child(1,19,span_tree::node::Kind::argument(false,None,None),parens_cr)
                .set_expression_id(Uuid::new_v4())
                ...
                .add_child(13,6,span_tree::node::Kind::this(false),PrefixCrumb::Arg)
                    .set_expression_id(Uuid::new_v4())
                    .done()
