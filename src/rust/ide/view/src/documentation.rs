...
ensogl::define_endpoints! {
    Input {
        ...
        /// Display documentation represented by Html code.
        display_doc_html (String),
    }
    Output {
...
impl View {
    ...
    fn init(self, scene:&Scene) -> Self {
        ...
        frp::extend! { network
            ...
            eval frp.display_doc_html      ((cont) model.display_doc(cont,InputFormat::Html     ));
