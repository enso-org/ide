...
ensogl::define_endpoints! {
    ...
    Output {
        ...
        visualization_code_changed      ((NodeId,data::EnsoCode)),
...
impl GraphEditorModelWithNetwork {
    ...
    , output        : &FrpEndpoints
        ...
        frp::new_bridge_network! { [self.network, node.frp.network] graph_node_bridge
            ...
            output.source.visualization_code_changed <+ node.model.visualization.frp.preprocessor
                .map(move |code| (node_id,code.clone()));
