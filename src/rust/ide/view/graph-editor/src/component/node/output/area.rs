...
#[derive(Clone,Debug)]
enum ShapeView {
    Single { view           : component::ShapeView<SinglePortShape> },
    Multi  { display_object : display::object::Instance,
             views          : Vec<component::ShapeView<MultiPortShape>> },
}
