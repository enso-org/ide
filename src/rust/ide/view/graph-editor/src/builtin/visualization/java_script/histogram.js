...
// Indicates whether script dependencies have been added to the DOM.
let scriptsInitialised = false;
...
class Histogram extends Visualization {
   ...
   */
  binCount() {
    return this._bins || DEFAULT_NUMBER_OF_BINS;
  }
    ...
    const zoom = d3
      ...
      .filter(function () {
        ...
        switch (d3.event.type) {
          case "mousedown":
            return (
              d3.event.button === right_button || d3.event.button === mid_button
            );
          case "wheel":
