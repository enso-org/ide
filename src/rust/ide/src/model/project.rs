...
pub trait API {
    ...
    fn module(&self, path:crate::model::module::Path) -> LocalBoxFuture<FallibleResult<model::Module>>;
    ...
    -> LocalBoxFuture<FallibleResult<model::ExecutionContext>>;
    ...
    // fn module_path_from_qualified_name
