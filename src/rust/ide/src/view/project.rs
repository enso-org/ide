...
impl ProjectView {
    ...
    fn setup_theme(app:&Application) {
        ...
        light.insert("graph_editor.node.background.color", color::Lcha::new(0.78,0.013,0.18,1.0));
        light.insert("graph_editor.node.selection.color", color::Lcha::new(0.29,0.5,0.22,1.0));
