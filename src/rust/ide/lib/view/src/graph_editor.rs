...
pub struct FrpInputs {
    ...
    pub set_method_pointer           : frp::Source<(ast::Id, OptionalMethodPointer)>,
...
///
/// `None` means that the node cannot be entered.
// TODO [mwu]
...
#[derive(Clone,Debug,Default,Shrinkwrap)]
pub struct OptionalMethodPointer(pub Option<Rc<enso_protocol::language_server::MethodPointer>>);
