...
impl application::shortcut::DefaultShortcutProvider for GraphEditor {
    fn default_shortcuts() -> Vec<application::shortcut::Shortcut> {
        ...
        vec! [ Self::self_shortcut(Press       , "escape"           , "cancel_project_name_editing")
             ...
             , Self::self_shortcut(Press       , "escape"           , "cancel_project_name_editing")
             , Self::self_shortcut(Press       , "ctrl + backspace" , "remove_selected_nodes")
             , Self::self_shortcut(Press       , "ctrl + space"     , "press_visualization_visibility")
             , Self::self_shortcut(DoublePress , "ctrl + space"     , "double_press_visualization_visibility")
             , Self::self_shortcut(Release     , "ctrl + space"     , "release_visualization_visibility")
             , Self::self_shortcut(Press       , "meta"             , "toggle_node_multi_select")
             , Self::self_shortcut(Release     , "meta"             , "toggle_node_multi_select")
             , Self::self_shortcut(Press       , "ctrl"             , "toggle_node_multi_select")
             , Self::self_shortcut(Release     , "ctrl"             , "toggle_node_multi_select")
             , Self::self_shortcut(Press       , "shift"            , "toggle_node_merge_select")
             , Self::self_shortcut(Release     , "shift"            , "toggle_node_merge_select")
             , Self::self_shortcut(Press       , "alt"              , "toggle_node_subtract_select")
             , Self::self_shortcut(Release     , "alt"              , "toggle_node_subtract_select")
             , Self::self_shortcut(Press       , "shift + alt"      , "toggle_node_inverse_select")
             , Self::self_shortcut(Release     , "shift + alt"      , "toggle_node_inverse_select")
             , Self::self_shortcut(Press       , "ctrl + d"         , "set_test_visualization_data_for_selected_node")
             , Self::self_shortcut(Press       , "ctrl + f"         , "cycle_visualization_for_selected_node")
             , Self::self_shortcut(Release     , "ctrl + enter"     , "enter_selected_node")
             , Self::self_shortcut(Release     , "ctrl + up"        , "exit_node")
             , Self::self_shortcut(Press       , "meta"             , "edit_mode_on")
             , Self::self_shortcut(Release     , "meta"             , "edit_mode_off")
             ]
    }
}
