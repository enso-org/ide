...
impl Network {
    ...
    (&self, label:Label, t1:&T1, t2:&T2, t3:&T3, t4:&T4, t5:&T5, t6:&T6, t7:&T7, t8:&T8, f:F) -> Stream<T>
        where T1:EventOutput, T2:EventOutput, T3:EventOutput, T4:EventOutput, T5:EventOutput,
              T6:EventOutput, T7:EventOutput, T8:EventOutput, T:Data,
              F:'static+Fn(&Output<T1>,&Output<T2>,&Output<T3>,&Output<T4>,&Output<T5>,&Output<T6>,&Output<T7>,&Output<T8>)->T {
...
{ src1:watch::Ref<T1>, src2:watch::Ref<T2>, src3:watch::Ref<T3>, src4:watch::Ref<T4>
    ...
    , function:F }
pub type   OwnedAllWith8 <T1,T2,T3,T4,T5,T6,T7,T8,F> = stream::Node     <AllWith8Data<T1,T2,T3,T4,T5,T6,T7,T8,F>>;
pub type   AllWith8      <T1,T2,T3,T4,T5,T6,T7,T8,F> = stream::WeakNode <AllWith8Data<T1,T2,T3,T4,T5,T6,T7,T8,F>>;
...
impl<T1,T2,T3,T4,T5,T6,T7,T8,F,Out> HasOutput for AllWith8Data<T1,T2,T3,T4,T5,T6,T7,T8,F>
    where T1:EventOutput, T2:EventOutput, T3:EventOutput, T4:EventOutput, T5:EventOutput,
          ...
          F:'static+Fn(&Output<T1>,&Output<T2>,&Output<T3>,&Output<T4>,&Output<T5>,&Output<T6>,&Output<T7>,&Output<T8>)->Out {
    type Output = Out;
}
...
impl<T1,T2,T3,T4,T5,T6,T7,T8,F,Out> OwnedAllWith8<T1,T2,T3,T4,T5,T6,T7,T8,F>
    where T1:EventOutput, T2:EventOutput, T3:EventOutput, T4:EventOutput, T5:EventOutput,
          ...
          F:'static+Fn(&Output<T1>,&Output<T2>,&Output<T3>,&Output<T4>,&Output<T5>,&Output<T6>,&Output<T7>,&Output<T8>)->Out {
    /// Constructor.
    pub fn new(label:Label, t1:&T1, t2:&T2, t3:&T3, t4:&T4, t5:&T5, t6:&T6, t7:&T7, t8:&T8, function:F) -> Self {
        let src1 = watch_stream(t1);
        let src2 = watch_stream(t2);
        let src3 = watch_stream(t3);
        let src4 = watch_stream(t4);
...
impl<T1,T2,T3,T4,T5,T6,T7,T8,F,Out,T> stream::EventConsumer<T> for OwnedAllWith8<T1,T2,T3,T4,T5,T6,T7,T8,F>
    where T1:EventOutput, T2:EventOutput, T3:EventOutput, T4:EventOutput, T5:EventOutput,
          T6:EventOutput, T7:EventOutput, T8:EventOutput, Out:Data,
          F:'static+Fn(&Output<T1>,&Output<T2>,&Output<T3>,&Output<T4>,&Output<T5>,&Output<T6>,&Output<T7>,&Output<T8>)->Out {
    fn on_event(&self, stack:CallStack, _:&T) {
