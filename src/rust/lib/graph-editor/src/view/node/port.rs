...
pub struct Events {
<<<<<<< Updated upstream:src/rust/lib/graph-editor/src/component/node/port.rs
...
=======
    pub network        : frp::Network,
    pub cursor_mode    : frp::Stream<cursor::Style>,
    pub press          : frp::Stream<span_tree::Crumbs>,
    press_source       : frp::Source<span_tree::Crumbs>,
    cursor_style_source : frp::Merge<cursor::Style>,
>>>>>>> Stashed changes:src/rust/lib/graph-editor/src/view/node/port.rs
}
...
=======
        let cursor_mode    = (&cursor_style_source).into();
        let press          = (&press_source).into();
        let frp            = Events {network,cursor_mode,press,cursor_style_source,press_source};
>>>>>>> Stashed changes:src/rust/lib/graph-editor/src/view/node/port.rs
