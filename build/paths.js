...
paths.dist.wasm.main      = path.join(paths.dist.wasm.root,'enso_ide.wasm')
paths.dist.wasm.mainRaw   = path.join(paths.dist.wasm.root,'enso_ide_bg.wasm')
paths.dist.wasm.glue      = path.join(paths.dist.wasm.root,'enso_ide.js')
paths.dist.wasm.mainOpt   = path.join(paths.dist.wasm.root,'enso_ide_opt.wasm')
paths.dist.wasm.mainOptGz = path.join(paths.dist.wasm.root,'enso_ide_opt.wasm.gz')
